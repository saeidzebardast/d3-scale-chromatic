...
**This is a bower repository which contains standalone d3-scale-chromatic and dependencies. *If you are not using bower, use [main d3-scale-chromatic library](https://github.com/d3/d3-scale-chromatic).***

### Installing as bower dependency

```
bower install d3-scale-chromatic
```

*The below texts are from [main d3-scale-chromatic library](https://github.com/d3/d3-scale-chromatic).*
